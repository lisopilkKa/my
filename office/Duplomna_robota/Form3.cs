...
namespace Duplomna_robota
{
    public partial class Form3 : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                fn = "";
                fi = new FileInfo(Path.GetDirectoryName(Application.ExecutablePath) + "АРКУШ успішності (бігунок) П (3) — копия — копия.doc");
                ...
                need();
                find.Text = "<Word15>";
                find.Replacement.Text = textBox12.Text;
                need();
                find.Text = "<Word16>";
                find.Replacement.Text = textBox13.Text;
                need();
                find.Text = "<d2>";
                find.Replacement.Text = textBox14.Text;
                need();
                find.Text = "<Word17>";
